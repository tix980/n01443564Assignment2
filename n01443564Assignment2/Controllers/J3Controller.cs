...
namespace n01443564Assignment2.Controllers
{
    public class J3Controller : ApiController
    {
        ...
        ///create a method that can calculate the total distance from a starting city to other 4 cities by
        ///entering four positive intergers that represent distances between those cities.  
        /// <summary>
        /// The method will take in four positive intergers that represent consecutive distances between consecutive 
        /// pairs of cities and return sentences that describe the distance between the starting city to other cities.
        /// </summary>
        /// <param name="line1">distance between starting city to city 2</param>
        /// <param name="line2">distance between city 2 to city 3</param>
        /// <param name="line3">distance between city 3 to city 4</param>
        /// <param name="line4">distance between city 4 to city 5</param>
        ...
        public string Distance(int line1,int line2,int line3,int line4)
        {
            ...
            {
                sum += AllDistance[i];
                output = output+ sum + DistanceMessage + i + " to city " + (i +1) + " is " + sum +". ";
            } return output;
        }
    }
}
